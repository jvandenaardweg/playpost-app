describe('Onboarding', () => {
  ...
  // it('should show a onboarding title', async () => {
  //   await expect(element(by.id('onboarding-slider-item-title'))).toBeVisible();
  // });

  // it('should show a onboarding text', async () => {
  //   await expect(element(by.id('onboarding-slider-item-text'))).toBeVisible();
  // });
});
