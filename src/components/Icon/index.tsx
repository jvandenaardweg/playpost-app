...
export const AntDesign = React.memo((props: IconProps) => <AntDesignIcons {...props} />);
export const MaterialCommunityIcons = React.memo((props: IconProps) => <MaterialCommunityIconsI {...props} />);
