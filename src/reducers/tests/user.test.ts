import { CREATE_USER_FAIL_MESSAGE, DELETE_USER_FAIL_MESSAGE, GET_USER_FAIL_MESSAGE, SAVE_SELECTED_VOICE_FAIL_MESSAGE, UPDATE_USER_EMAIL_FAIL_MESSAGE, UPDATE_USER_PASSWORD_FAIL_MESSAGE } from '../../constants/messages';
import { CREATE_USER, CREATE_USER_FAIL, CREATE_USER_SUCCESS, DELETE_USER, DELETE_USER_FAIL, DELETE_USER_SUCCESS, GET_USER, GET_USER_FAIL, GET_USER_SUCCESS, initialState, RESET_SAVE_SELECTED_VOICE_ERROR, RESET_USER_ERROR, RESET_USER_STATE, SAVE_SELECTED_VOICE, SAVE_SELECTED_VOICE_FAIL, SAVE_SELECTED_VOICE_SUCCESS, UPDATE_USER_EMAIL, UPDATE_USER_EMAIL_FAIL, UPDATE_USER_EMAIL_SUCCESS, UPDATE_USER_PASSWORD, UPDATE_USER_PASSWORD_FAIL, UPDATE_USER_PASSWORD_SUCCESS, userReducer } from '../user';
